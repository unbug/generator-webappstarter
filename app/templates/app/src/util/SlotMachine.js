define(function(require, exports, module) {
    function SlotMachine(option){
        ...
        function slideLose(){
            ...
            var _list = ['B','C'],
                rs = [];
            rs = _list.sort(function(){return randomBool();});
        ...
        function moveTo(option){
            ...
            option.el.css({'-webkit-transform': 'translate3D(0px,' + -option.move+'px,0px)','-webkit-transition': '-webkit-transform '+option.time+'ms ease-in-out'});
        }
        this.reset = function(){
